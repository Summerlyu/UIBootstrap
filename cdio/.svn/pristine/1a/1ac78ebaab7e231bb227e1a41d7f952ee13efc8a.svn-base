;(function(e){
	e.scrollUp=function(t){
		var n={
			...
			scrollImg:false,activeOverlay:false
		};
		var r=e.extend(
				{},n,t),i="#"+r.scrollName;e("<a/>",
				{id:r.scrollName,href:"#top",title:r.scrollText}
			).appendTo("body");
		if(!r.scrollImg){
		...
		if(r.activeOverlay){
			...
			e(i+"-active").css({
				...
				width:"100%","border-top":"1px dotted "+r.activeOverlay,
				"z-index":"2147483647"})
		}
	...
	e(i).click(function(t){e("html, body").animate({scrollTop:0},r.topSpeed);
