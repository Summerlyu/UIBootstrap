		...
		<fieldset>
			<div id="shop-verify">
				...
				<div class="hd clearfix">
					...
					<span class="floatleft title"><i class="num"  style="opacity:0"></i>讲师评价列表</span>
					</div>
								<div class="bd">
														...
														<table class="table table-striped">
															...
															<tbody>
																<s:iterator value="page.results">
																	<tr>
																		<td><s:property value="coachID" />
																		</td>
																		<td><s:property value="stuName" />
																		</td>
																		<td><s:property value="" /> <!-- 暂定为显示五级联动的内容 -->
																		</td>
																		<td>
																		  <s:property value="time" />
																	    </td>
																		<td><s:property value="star" />
																		</td>
																		<td><a href="<s:url value=""/>"> <!-- 连接到讲师查看评价界面 -->
										                                                                   查看评价详情</a>
																		</td>
													...
													<s:form action='teachHishoryCoa' id="trsForm">
														<div class="pagination pagination-right">
															...
															<li
														  		...
														  		<s:if test="page.hasPreviousPage"><a href="<s:url value="teachHishoryCoa"/>?index=<s:property value="page.index-1"/>"><<</a></s:if>
														  	</li>
														  	<s:iterator begin="%{pageMin}" end="%{pageMax}" status="pageNo">
														  		<li
														  			...
														  			<s:if test="page.index!=(#pageNo.index+pageMin)"><a href="<s:url value="teachHishoryCoa"/>?index=<s:property value="#pageNo.index+pageMin"/>"><s:property value="#pageNo.index+pageMin"/></a></s:if>
														  		</li>
														  	</s:iterator>
														    <li <s:if test="!page.hasNextPage">class="disabled"</s:if>>
														  		<s:if test="!page.hasNextPage"><span>>></span></s:if>
														  		<s:if test="page.hasNextPage"><a href="<s:url value="teachHishoryCoa"/>?index=<s:property value="page.index+1"/>">>></a></s:if>
														    </li>
															</ul>
