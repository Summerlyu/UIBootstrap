package cn.edu.fjnu.dao.common;
...
public class GenericDaoTest {
	...
	@Test
	public <T> void testQueryOneBySQL() {
		ApplicationContext ctx = new ClassPathXmlApplicationContext(
				"applicationContext.xml");
		Assert.assertNotNull(ctx);
		GenericDao genericDao = (GenericDao) ctx.getBean("genericDao");
...
//		genericDao.queryOneBySQL(User.class, sql);
		genericDao.queryOneBySQL(cn.edu.fjnu.cdio.model.common.User.class, sql);
	}

	@Test
	public <T> void testQueryOneBySQLParams() {
		ApplicationContext ctx = new ClassPathXmlApplicationContext(
				"applicationContext.xml");
		Assert.assertNotNull(ctx);
		GenericDao genericDao = (GenericDao) ctx.getBean("genericDao");
		...
		String sql = "select * from t_user where t_user.user_name = ? and t_user.age > ?";
		Map<String, Object> params = new HashMap<String, Object>();
		params.put("1", "lai");
		params.put("2", 12);
		genericDao.queryOneBySQL(cn.edu.fjnu.cdio.model.common.User.class, sql,params);
	}
	
	@Test
	public <T> void testQueryListBySQL() {
		ApplicationContext ctx = new ClassPathXmlApplicationContext(
				"applicationContext.xml");
		Assert.assertNotNull(ctx);
		GenericDao genericDao = (GenericDao) ctx.getBean("genericDao");
		...
		String sql = "select * from t_user;";
//		genericDao.queryOneBySQL(User.class, sql);
		genericDao.queryListBySQL(cn.edu.fjnu.cdio.model.common.User.class, sql);
	}
	
	@Test
	public <T> void testQueryListBySQLParam() {
		ApplicationContext ctx = new ClassPathXmlApplicationContext(
				"applicationContext.xml");
		Assert.assertNotNull(ctx);
		GenericDao genericDao = (GenericDao) ctx.getBean("genericDao");
		...
		params.put("1", "lai");
		params.put("2", 12);
		genericDao.queryListBySQL(cn.edu.fjnu.cdio.model.common.User.class, sql,params);
	}
}
