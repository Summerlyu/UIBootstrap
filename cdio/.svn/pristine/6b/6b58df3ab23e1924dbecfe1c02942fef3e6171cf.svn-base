...
public class ImageUtils {
    ...
    public final static void base64StringToImage(String base64String, String path) {
		...
		try {
			...
			ImageIO.write(bi1, IMAGE_TYPE_PNG, w2);// 不管输出什么格式图片，此处不需改动			
			bais.close();
		} catch (IOException e) {
			e.printStackTrace();
			logger.error(e);
	...
	public final static BufferedImage base64StringToBufferedImage(String base64String) {
		BASE64Decoder decoder = new sun.misc.BASE64Decoder();
	 ...
	 * @return
	 */
	public final static String rootPath(Class<?> T)
	{
		String str2 = T.getResource("/").toString();
		String[] str22 = str2.split("/WEB-INF/classes/");
		String keyname2 = str22[str22.length - 1];
		String[] str33 = keyname2.split("file:/");
		String rootpath = str33[str33.length - 1]+"/upload_files/pics/";
