...
<html>
 ...
 <span style="display:none" id="pym_donsuccessEp"><s:property value="ep"/></span>
 
 
 <div class="container">
      <legend><span class="pym_donHead">爱心动态</span></legend>
      <br/>
      <br/>
    <h5><img class="pym_donSun" src="image/pym/pym_sun.png">总捐献点数:<span class="pym_donEPcolor"><s:property value="receiveEp"/>EP</span></h5>
    <form class="form-inline" action=<c:url value="/pym/dynamicLove"/> method="post">
     <label class="pym_queFont"><h4>爱心动态查询:　</h4></label> 	         
	       ...
	       <label class="pym_queFont"><h4>至</h4></label>
	         <div class="input-append date form_datetime" data-date="2013-02-21T15:25:00Z">
	             <s:textfield name="rhp.endTime" readonly="true"></s:textfield>
	             <span class="add-on"><i class="icon-remove"></i></span>
	             <span class="add-on"><i class="icon-calendar"></i></span>
	         </div>　
	       <button type="submit" class="btn btn-success" style="width:10%;">查询</button>
	   </form>
			               ...
			               <s:iterator value="dt">   
			                 <div class="media" style="margin-top:0px;">
		                          ...
		                          <div class="media-body">
		                               <div class="border2"></div>
		                               <span ><img class="pym_donIcro" src="image/pym/pym_donUser.jpg">捐献:
		                               <span class="pym_donColor"><s:property value="doEP"/>EP</span>&nbsp&nbsp|&nbsp&nbsp时间:<fmt:formatDate value="${doTime}" pattern="yyyy-MM-dd HH:mm"/></span>
		                               <div class="border1">
		                                      <div style="font-weight:bold;">祝福:</div>
		                                      <div>
		                                      <s:property value="doGrate"/>
		                                      <!-- Nested media object -->                      
		                                      </div>
		                               </div>  
		                          </div>      
                                  ...
                                  <div class="pagination">
                                      <div class="row-fluid">
                                          <div class="span7">
                                            <ul>                                                                                              
										       <li>
												   <s:if test="pg.hasPreviousPage">
												         <span onclick="doQuery(<s:property value="pg.index-1"/>)"><<</span>
												   </s:if>											   
											   </li>
											   <s:iterator begin="%{pagebegin}" end="%{pageend}" status="pageNo">
											   <li <s:if test="pg.index==(#pageNo.index+pagebegin)">class="active"</s:if>>
												...
												<li>
												    <s:if test="pg.hasNextPage">
														<span onclick="doQuery(<s:property value="pg.index+1"/>)">>></span>
													</s:if>
												</li>                                                 
                                            </ul>
                                              <span class="page-skip">一共<s:property value="pg.totalPage" />页</span>
                                          </div>
...
<script type="text/javascript">
	...
	<script type="text/javascript">
       ...
       {
           //alert(pageno);
           if(pageno<1 || pageno><s:property value="pg.totalRecord"/>)
           {
            ...
            f.action=f.action+"?pg.index="+(pageno);
            f.submit();
         }
    </script>
