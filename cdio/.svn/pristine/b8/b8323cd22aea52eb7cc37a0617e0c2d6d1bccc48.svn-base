							...
							<div class="shop-result">
								<div class="fm-input">
									<div id="expand-all-extend" class="ui-expand ">
										...
										<div class="fm-items">
											<label class="fm-labels">培训证号：</label>
											<s:property value="coach.ctrain_num" />
										</div>

										<div class="fm-items">
											<label class="fm-labels">提交申请时间：</label>
											<s:property value="coach.sub_cer_date" />
										</div>

										<div class="verify-line">
											<label class="fm-line"><strong>相关证照</strong>
											</label>
										...
										<div class="zoomingDemo">
											<!-- <img src="/cdio2010/image/coa/head.jpg" height="100"
												...
												<!-- <img  id="pics"   width=165 height=112 src="/cdio2010/image/coa/head.jpg"/> -->
											<img id="pics" width=165 height=112 src="<s:url action="getCoa_licenseAction"/>?coach.id=<s:property value="coach.id"/>"/> <!-- 这个根据自己写的改 -->
										</div>
								...
								<div align="center">
									<a class="btn btn-success" href="<s:url value="isPassCAction"/>?coachID=<s:property value="coach.id" />"> 通过  </a>
                                     <a class="btn btn-success" style="margin-left:15%;" onclick="ModalResize()" > 不通过  </a>
                                     
									<!-- <span class="view" style="margin-left:15%;">
									嵌套显示详情的代码
									<a id="modal-92494" class="btn btn-success" contenteditable="true"
										data-toggle="modal" role="button"
										href="#modal-container-92494"> 不通过 </a>
										
										
									<div id="modal-container-92494" class="modal hide fade"
										aria-hidden="true" aria-labelledby="myModalLabel"
										role="dialog" tabindex="-1" style="display: none;">
										<s:form action="notPassCAction" method="post" 
										...
										<div class="modal-footer">
											<button class="btn" contenteditable="true" aria-hidden="true"
 ...
 -->
 									...
 									<div id='noPass' style="width:50%; margin-left: auto;margin-right: auto;margin-top:5%;display:none;border:1px solid #EFEFEF;">
										...
										<div class="modal-footer">
											...
											<a class="btn btn-success" href="<s:url value="notPassCAction"/>?coachID=<s:property value="coach.id" />"> 确认 </a>
										</div>
									</div>
