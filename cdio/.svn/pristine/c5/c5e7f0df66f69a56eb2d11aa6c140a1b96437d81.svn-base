...
function changeCity(obj){
	...
	$.ajax({
		...
		success:function(msg){
			//清空下拉框选项
			$("#selectArea").empty();
	        $("#selectArea").append('<option value="">==请选择县区==</option>');
	        //开启下拉框架
...
<body data-target=".bs-docs-sidebar" data-spy="scro">
	...
	<s:form action="UpdateAction" method="post" enctype="multipart/form-data">
		<fieldset>
			<div id="shop-verify">
				<div id="shop-owner-verify" class="verify-module verify-disable">
					<div class="hd clearfix">
					<span  class="title"><i class="num"  style="opacity:0"></i><img src="/cdio2010/image/coa/update.png" style="margin-top:o.5%" height="40" width="40"></span>
					
						<span class="title"><i class="num"  style="opacity:0"></i>修改个人信息</span>
					...
					<div class="fm-input">
					<div id="expand-all-extend" class="ui-expand "><div> 
											<!-- &lt;div class=&quot;fm-item J_extend_required&quot;&gt; --> 
											
											</div><s:hidden name="coachID"></s:hidden>
											<div class="container-fluid">
											<div class="row-fluid">
												<div class="span8">
										    <div class="fm-item">
											<label class="fm-label"><span class="required">*</span>姓名：</label>
											<s:textfield cssClass="i-text" name="coach.name" maxlength="128"/>
										    </div>
											...
											<s:select cssClass="input-small" name="coach.sex"
											                                 list="#{\"男\":'男',\"女\":'女'}"/>
										    </div>
										    ...
										    <div class="fm-item">
												<label for="passnum" class="fm-label"><span
													...
													<div class="input-append date form_datetime" data-date="2013-05-10T">
														<s:textfield size="8" name="coach.birth"  readonly="true" />
											...
											<s:textfield cssClass="i-text" name="coach.job" maxlength="128"/>
										    </div>
										    
										    <%-- <div class="fm-item">
											<label class="fm-label"><span class="required">*</span>工作单位：</label>
											<s:select cssClass="input-small" name="coach.workPlace"
											                                 list="#{\"莆田\":'莆田',\"b\":'长沙',\"长沙\":'长沙',\"武汉\":'武汉'}"/>
											<s:select cssClass="input-small" name="coach.workPlace"
											                                 list="#{\"莆田\":'莆田',\"b\":'长沙',\"长沙\":'长沙',\"武汉\":'武汉'}"/>
											<s:select cssClass="input-small" name="coach.workPlace"
											                                 list="#{\"莆田\":'莆田',\"b\":'长沙',\"长沙\":'长沙',\"武汉\":'武汉'}"/>
...
<div class="span4">	
										    ...
										    <!--  图片自动剪裁功能暂缺 -->
										   <div id="preview">
  	                                            <img id="imghead" src="<s:url action="getpicAction"/>?coach.id=<s:property value="coach.id"/>" style="width:100;height:100" />
  		                                   </div>	
									       </div>
	...
	<div align="center">
		<s:submit cssClass="btn btn-success" value="修   改" align="center">
		</s:submit>
	</div>
	</div>
	</div>
