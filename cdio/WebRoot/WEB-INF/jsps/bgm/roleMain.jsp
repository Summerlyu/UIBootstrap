...
<body>
	...
	<div class="container-fluid">
		<s:form action="load" method="post" namespace="/role">
			<div class="row-fluid">
				<div class="span8">
					名称：
		...
		<div class="widget-box">
			<div class="widget-title">
				<input type="button" value="新增" class="btn btn-success"
					...
					onclick="location.href='<s:url namespace="/role" action="input"/>'" />
				<input type="button" value="删除" class="btn btn-success"
					style="margin: 5px 0px 5px 0;" onclick="deleteRole();" />
			</div>
			<div class="widget-content nopadding">

				<div id="DataTables_Table_0_wrapper" class="dataTables_wrapper">
					<s:form action="delete" method="post" namespace="/role"
						id="deleteForm">
						<table
							...
							<tbody>
								<s:iterator value="page.results">
									<tr>
										...
										<td><a
											href="<s:url namespace="/role" action="updateP?roleID=%{roleID}"/>">修改</a>
										</td>
									</tr>
								</s:iterator>
							</tbody>
