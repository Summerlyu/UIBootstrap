		...
		<fieldset>
			<div id="shop-verify">
				<div id="shop-owner-verify" class="verify-module verify-disable">
					...
					<span class=" title"><i class="num"  style="opacity:0"></i>讲师个人信息</span>
					</div>
					<div class="bd">
							...
							<div class="shop-result">
								<div class="fm-input">
										<div id="expand-all-extend" class="ui-expand ">
											...
											<s:property value="coach.workPlace"/>
										    </div>
										    ...
										    <div class="fm-items">
											<label class="fm-labels">提交实名认证时间：</label>
											<s:property value="coach.sub_real_date"/>
										    </div>
										    
										    <div class="fm-items">
											<label class="fm-labels">提交资格认证时间：</label>
