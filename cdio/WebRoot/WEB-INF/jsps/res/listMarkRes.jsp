   ...
   <style type="text/css">
    ...
    <script type="text/javascript">
       function removeRes(resId,resName){
       	 if(confirm("确认要删除对《"+resName+"》资料的收藏吗?")){
         	location.href='<s:url action="deleteMarkResAction"  namespace="/resPerMark"/>?rd.resId='+resId;
          }
       }
       function doQuery(pageno)
       {
           ...
           pageno=pageno-1;
           location.href='<s:url action="loadAllMarkResAction" />?index='+pageno;
  ...
  <body>
    ...
    <div class="minicontainer" style="height:180%;padding-left:40px" >
     <div class="tabbable" >
       ...
       <div class="tab-pane active" id="collect">
	      ...
	      <thead>
	          <tr>
	          	  ...
	          	  <th class="tableheader font-kind" width="8%">收藏数</th>
	          	  <th class="tableheader font-kind" width="15%">收藏时间</th>
	          ...
	          <s:iterator value="page.results">
	              <tr>
	                  ...
	                  <td><s:property value="resMark"/></td>
	                  <td><s:date name="resUploaddate" format="yyyy-MM-dd HH:mm:ss"/>
	                  <!--<td><a href="<s:url action="deleteMarkResAction"/>?rd.resId=<s:property value="resId"/>"  class="operand" >删除收藏&nbsp;<i class="icon-remove"></i></a></td>
	              	   -->
	              	  <td><button style="height:25px;" class="operand" type="button" onclick="removeRes(<s:property value="resId"/>,'<s:property value="resName"/>');">删除&nbsp;<i class="icon-remove"></i></button></td>
	              </tr>
	          </s:iterator>
	      </table>
	    </div>
      <!-- 分页 -->
		<div class="pagination" style="padding-left:35%">
			<ul>
			<s:if test="index>0">
			<li><a href="<s:url action="loadAllMarkResAction"/>?index=<s:property value="index-1"/>"><<</a></li>
			</s:if>
		
		<s:if test="index<3">
			<s:if test="Page.totalPage>0">
			<li><a href='<s:url action="loadAllMarkResAction"/>?index=0'>1</a></li>
			</s:if>
			<s:if test="Page.totalPage>1">
			<li><a href='<s:url action="loadAllMarkResAction"/>?index=1'>2</a></li>
			</s:if>	
			<s:if test="Page.totalPage>2">
			<li><a href='<s:url action="loadAllMarkResAction"/>?index=2'>3</a></li>
			</s:if>
			<s:if test="Page.totalPage>3">
			<li><a href='<s:url action="loadAllMarkResAction"/>?index=3'>4</a></li>
			</s:if>
			<s:if test="Page.totalPage>4">
			<li><a href='<s:url action="loadAllMarkResAction"/>?index=4'>5</a></li>
			</s:if>
			<s:if test="Page.totalPage>5">
			<li><a href='<s:url action="loadAllMarkResAction"/>?index=5'>...</a></li>
			</s:if>
		</s:if>	
		<s:if test="index>2&&index<Page.totalPage-5">
			<li><a href='<s:url action="loadAllMarkResAction"/>?index=<s:property value="index-2"/>'><s:property value="index-1"/></a></li>
			<li><a href='<s:url action="loadAllMarkResAction"/>?index=<s:property value="index-1"/>'><s:property value="index"/></a></li>
			<li><a href='<s:url action="loadAllMarkResAction"/>?index=<s:property value="index"/>'><s:property value="index+1"/></a></li>
			<li><a href='<s:url action="loadAllMarkResAction"/>?index=<s:property value="index+1"/>'><s:property value="index+2"/></a></li>
			<li><a href='<s:url action="loadAllMarkResAction"/>?index=<s:property value="index+2"/>'><s:property value="index+3"/></a></li>
			<s:if test="Page.totalPage>5">
			<li><a href='<s:url action="loadAllMarkResAction"/>?index=5'>...</a></li>
			</s:if>
		</s:if>
		...
		<s:if test="index>4&&Page.totalPage-index<6">
			...
			<li><a href='<s:url action="loadAllMarkResAction"/>?index=<s:property value="Page.totalPage-5"/>'><s:property value="Page.totalPage-4"/></a></li>
			</s:if>
			<s:if test="index<Page.totalPage-3">
			<li><a href='<s:url action="loadAllMarkResAction"/>?index=<s:property value="Page.totalPage-4"/>'><s:property value="Page.totalPage-3"/></a></li>
			</s:if>	
			<s:if test="index<Page.totalPage-2">
			<li><a href='<s:url action="loadAllMarkResAction"/>?index=<s:property value="Page.totalPage-3"/>'><s:property value="Page.totalPage-2"/></a></li>
			</s:if>
			<s:if test="index<Page.totalPage-1">
			<li><a href='<s:url action="loadAllMarkResAction"/>?index=<s:property value="Page.totalPage-2"/>'><s:property value="Page.totalPage-1"/></a></li>
			</s:if>
			<li><a href='<s:url action="loadAllMarkResAction"/>?index=<s:property value="Page.totalPage-1"/>'><s:property value="Page.totalPage"/></a></li>
		</s:if>

		<s:if test="index<page.totalPage-1">
		<li><a href='<s:url action="loadAllMarkResAction"/>?index=<s:property value="index+1"/>'>下一页</a></li>
		</s:if>
