					...
					success : function(result) {
						...
						$(function() {
							...
							var colors = Highcharts.getOptions().colors, categories = [
									'教学态度', '教学内容', '教学方法', '教学质量' ], name = '学生动态评价分析图', data = [
									{
						...
						$(function() {
							...
							var colors = Highcharts.getOptions().colors, categories = [
									'最近一周', '最近一个月', '最近六个月', '六个月之前' ], name = '学生满意度评分分析图', data = [
									{
										y : result.y1,
										color : colors[4],
										drilldown : {
